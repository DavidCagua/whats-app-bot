...
export function BusinessSettingsForm({
  ...
  const onSubmit = async (data: BusinessSettingsFormData) => {
    ...
    try {
      const payload =
        data.business_type === "restaurant" ? data : { ...data, menu_url: "" };
            ...
            <div className="flex items-center justify-between gap-4 rounded-lg border p-4">
              <div className="space-y-1">
                ...
                <p className="text-sm text-muted-foreground">
                  Cuando está apagado, los mensajes entrantes se guardan pero no
              ...
              <div className="flex items-center gap-2 shrink-0">
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    form.setValue("agent_enabled", checked)
                  }
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="md:col-span-2 flex items-center justify-between rounded-lg border p-4">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Permite a los clientes ver el menú y realizar pedidos por
                    WhatsApp
                  </p>
                </div>
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    form.setValue("products_enabled", checked)
                  }
                />
              </div>

              <div className="md:col-span-2 space-y-2">
                <Label htmlFor="conversation_primary_agent">
                  Agente principal en WhatsApp
                </Label>
                <Select
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="booking">
                      Reservas / citas (booking)
                    </SelectItem>
                    <SelectItem value="order">Pedidos (order)</SelectItem>
                    <SelectItem value="sales">
                      Ventas / catálogo (sales)
                    </SelectItem>
                    <SelectItem value="support">Soporte (support)</SelectItem>
                  </SelectContent>
                </Select>
                <p className="text-sm text-muted-foreground">
                  Si eliges un agente, todos los mensajes van a él mientras esté
                  habilitado en la sección Agentes IA. Déjalo en automático solo
                  si el primero por prioridad es el que quieres.
                </p>
              </div>
              ...
              {form.watch("business_type") === "restaurant" && (
                <div className="md:col-span-2 space-y-2">
                  ...
                  />
                  <p className="text-sm text-muted-foreground">
                    Enlace al menú completo. El asistente lo incluirá en el
                    saludo inicial.
                  </p>
                </div>
              )}
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                />
                <p className="text-sm text-muted-foreground">
                  Opcional. Lo usa el asistente cuando el cliente quiere pagar
                  (por ejemplo Stripe o Mercado Pago).
                </p>
                {form.formState.errors.payment_link && (
                  <p className="text-sm text-red-500">
                    {form.formState.errors.payment_link.message}
                  </p>
                )}
              </div>
          ...
          <CardContent>
            <div className="space-y-2">
              ...
              {form.formState.errors.ai_prompt && (
                <p className="text-sm text-red-500">
                  {form.formState.errors.ai_prompt.message}
                </p>
              )}
            </div>
          </CardContent>
