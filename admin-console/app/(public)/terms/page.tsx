        ...
        <div className="prose prose-gray max-w-none space-y-6">
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              By accessing or using our WhatsApp Bot service
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Our Service provides a multi-tenant WhatsApp bot platform that
              enables businesses to manage customer appointments through
              automated conversations. The Service includes:
            </p>
            <ul className="list-disc pl-6 mt-2 space-y-2 text-gray-700">
              <li>WhatsApp integration for customer communication</li>
              <li>
                AI-powered natural language processing for appointment
                scheduling
              </li>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              Business administrators must create an account to access the admin
              console. You are responsible for:
            </p>
            <ul className="list-disc pl-6 mt-2 space-y-2 text-gray-700">
              <li>
            ...
            <p className="text-gray-700 leading-relaxed">
              Customers who interact with your business through WhatsApp are
              subject to these Terms. By using the WhatsApp bot, end users agree
              to the automated processing of their messages and appointment
              information.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              WhatsApp (Meta) and OpenAI. Your use of these third-party services
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-2 text-gray-700">
              <li>
                We will create, read, update, and delete appointment records as
                needed for scheduling
              </li>
              <li>
                Your business and customer data is stored securely with access
                controls
              </li>
              <li>You can request account or data deletion at any time</li>
              <li>
                Deleting your account will disable appointment scheduling
                features
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              uninterrupted service. The Service may be unavailable due to:
            </p>
            <ul className="list-disc pl-6 mt-2 space-y-2 text-gray-700">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              collect and process data as described in the Privacy Policy. By
              using the Service, you consent to such processing and warrant that
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mt-4">
              You retain ownership of your business data, customer
              conversations, and appointment information. By using the Service,
              you grant us a license to use this data solely for providing and
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-2 text-gray-700">
              ...
              <li>
                AI-generated responses that are inaccurate or inappropriate
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-2 text-gray-700">
              ...
              <li>
                The AI-generated responses will always be appropriate or correct
              </li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 mt-2 space-y-2 text-gray-700">
              ...
              <li>
                Your business&apos;s interactions with customers through the
                Service
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed mt-4">
              ...
              cease. We may delete your data according to our data retention
              policies.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              We will provide notice of significant changes by posting a notice
              on the Service or sending an email. Your continued use of the
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              the laws of the Republic of Colombia, without regard to its
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              Service shall be resolved through binding arbitration, except that
              either party may seek injunctive relief in court for intellectual
              property infringement or violation of confidentiality obligations.
            </p>
          </section>
