...
- get_business_info(field): datos del negocio. Elige el `field` correcto según lo que pregunta el cliente. Lee la descripción de la herramienta para los matices ("payment_details" para "donde transfiero", NUNCA "phone"; "menu_url" cubre "carta"/"menú" con cualquier verbo).
